## DronnerX6 Flight Controller
The Dronner X6 is a flight controller manufactured by Dronner, which is based on the open-source FMU v6X architecture and Pixhawk Autopilot Bus open source specifications.
...
## Pinout
![DronnerX6 Pinout](https://github.com/Dronner-Aero/ardupilot/blob/DronnerBootLoader/libraries/AP_HAL_ChibiOS/hwdef/DronnerX6/DronnerX6Pinout.jpg "DronnerX6")
